...
public class BluetoothSenssun extends BluetoothCommunication {
    private final String TAG = "BluetoothSenssun";
    ...
    protected boolean onNextStep(int stepNr) {
        switch (stepNr) {
            case 0:
                ...
                values = 0;
                LogManager.d(TAG, "Sync Date");
                synchroniseDate();
                break;
            case 1:
                LogManager.d(TAG, "Sync Time");
                synchroniseTime();
                break;
            default:
                return false;
    ...
    private void parseMeasurement(byte[] data) {
        switch(data[5]) {
            ...
            case (byte)0xA0:
                ...
                LogManager.d(TAG, String.format("the byte is %d stable is %s", (data[5] & 0xff), weightStabilized ? "true": "false"));
            ...
            case (byte)0xB0:
                ...
                values |= 2;
                LogManager.d(TAG, String.format("got fat %d", values));
            ...
            case (byte)0xC0:
                ...
                values |= 4;
                LogManager.d(TAG, String.format("got muscle %d", values));
            ...
            case (byte)0xD0:
                ...
                values |= 8;
                LogManager.d(TAG, String.format("got kal %d", values));
