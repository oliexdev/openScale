...
public class DataEntryActivity extends Activity {
    ...
    private MuscleAbsoluteMeasurementView muscleAbsoluteMeasurement;
    private FatMeasurementView fatMeasurement;
    private FatAbsoluteMeasurementView fatAbsoluteMeasurement;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        muscleAbsoluteMeasurement = new MuscleAbsoluteMeasurementView(context);
        fatMeasurement = new FatMeasurementView(context);
        fatAbsoluteMeasurement = new FatAbsoluteMeasurementView(context);
        ...
        dataEntryMeasurements.add(muscleAbsoluteMeasurement);
        dataEntryMeasurements.add(fatMeasurement);
        dataEntryMeasurements.add(fatAbsoluteMeasurement);
