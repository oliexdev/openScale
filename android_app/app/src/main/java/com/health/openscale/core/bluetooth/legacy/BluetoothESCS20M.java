        ...
        switch (msgID) {
            case MESSAGE_ID_WEIGHT_RESP:
                ...
                if (stableValue) {
                    ...
                    scaleMeasurement.setWeight(ConverterUtils.fromUnsignedInt16Be(msg, 8) / 100.0f);
                    ...
                    if (msg[10] != 0x00 && msg[11] != 0x00) {
                        ...
                        final int resistance = ConverterUtils.fromUnsignedInt16Be(msg, 10);
            ...
            case MESSAGE_ID_EXTENDED_RESP:
                ...
                final int resistance = ConverterUtils.fromUnsignedInt16Be(msg, 9);
