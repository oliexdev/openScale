...
public class BluetoothBeurerBF700 extends BluetoothCommunication {
    public final static String TAG = "BluetoothBeurerBF700";
...
//existiert nicht
    ...
    public BluetoothBeurerBF700(Context context) {
        super(context);
    }
