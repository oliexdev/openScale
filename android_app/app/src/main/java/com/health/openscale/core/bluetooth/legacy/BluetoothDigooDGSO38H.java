...
public class BluetoothDigooDGSO38H extends BluetoothCommunication {
    private final String TAG = "BluetoothDigooDGSO38H";
    ...
    private void parseBytes(byte[] weightBytes) {
            ...
            if (weightStabilized) {
                ...
                byte gender = selectedUser.gender.isMale() ? (byte)0x00: (byte)0x01;
                byte height = (byte) (((int) selectedUser.bodyHeight) & 0xFF);
                ...
                if (Math.abs(fat - 0.0) < 0.00001) {
                        LogManager.d(TAG, "Scale signaled that measurement of all data " +
