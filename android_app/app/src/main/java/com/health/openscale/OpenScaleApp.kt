...
fun getDefaultMeasurementTypes(): List<MeasurementType> {
    return listOf(
        ...
        MeasurementType(key = MeasurementTypeKey.BODY_FAT_LEFT_ARM, unit = UnitType.PERCENT, color = 0xFFE57373.toInt(), icon = MeasurementTypeIcon.IC_BODY_FAT, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.BODY_FAT_RIGHT_ARM, unit = UnitType.PERCENT, color = 0xFFEF5350.toInt(), icon = MeasurementTypeIcon.IC_BODY_FAT, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.BODY_FAT_TORSO, unit = UnitType.PERCENT, color = 0xFFD32F2F.toInt(), icon = MeasurementTypeIcon.IC_BODY_FAT, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.BODY_FAT_LEFT_LEG, unit = UnitType.PERCENT, color = 0xFFEF9A9A.toInt(), icon = MeasurementTypeIcon.IC_BODY_FAT, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.BODY_FAT_RIGHT_LEG, unit = UnitType.PERCENT, color = 0xFFE53935.toInt(), icon = MeasurementTypeIcon.IC_BODY_FAT, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.MUSCLE_LEFT_ARM, unit = UnitType.PERCENT, color = 0xFF81C784.toInt(), icon = MeasurementTypeIcon.IC_MUSCLE, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.MUSCLE_RIGHT_ARM, unit = UnitType.PERCENT, color = 0xFF66BB6A.toInt(), icon = MeasurementTypeIcon.IC_MUSCLE, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.MUSCLE_TORSO, unit = UnitType.PERCENT, color = 0xFF43A047.toInt(), icon = MeasurementTypeIcon.IC_MUSCLE, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.MUSCLE_LEFT_LEG, unit = UnitType.PERCENT, color = 0xFFA5D6A7.toInt(), icon = MeasurementTypeIcon.IC_MUSCLE, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.MUSCLE_RIGHT_LEG, unit = UnitType.PERCENT, color = 0xFF2E7D32.toInt(), icon = MeasurementTypeIcon.IC_MUSCLE, isEnabled = true),
