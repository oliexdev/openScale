...
fun getDefaultMeasurementTypes(): List<MeasurementType> {
    return listOf(
        ...
        MeasurementType(key = MeasurementTypeKey.SKELETAL_MUSCLE, unit = UnitType.PERCENT, color = 0xFF43A047.toInt(), icon = MeasurementTypeIcon.IC_MUSCLE, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.LEAN_SOFT_TISSUE, unit = UnitType.KG, color = 0xFF7CB342.toInt(), icon = MeasurementTypeIcon.IC_MUSCLE, isEnabled = true),
        ...
        MeasurementType(key = MeasurementTypeKey.SUBCUTANEOUS_FAT, unit = UnitType.PERCENT, color = 0xFFFF7043.toInt(), icon = MeasurementTypeIcon.IC_BODY_FAT, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.BODY_AGE, inputType = InputFieldType.INT, unit = UnitType.NONE, color = 0xFF7B1FA2.toInt(), icon = MeasurementTypeIcon.IC_M_PERSON, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.BMI_22_REFERENCE_WEIGHT, unit = UnitType.KG, color = 0xFF5E35B1.toInt(), icon = MeasurementTypeIcon.IC_WEIGHT, isEnabled = true),
        ...
        MeasurementType(key = MeasurementTypeKey.DEVICE_IMPEDANCE, unit = UnitType.OHM, color = 0xFF546E7A.toInt(), icon = MeasurementTypeIcon.IC_DEFAULT, isEnabled = false, isInternal = true),
        MeasurementType(key = MeasurementTypeKey.PHASE_ANGLE, unit = UnitType.DEGREE, color = 0xFF00897B.toInt(), icon = MeasurementTypeIcon.IC_M_SCATTER_PLOT, isEnabled = true),
        MeasurementType(key = MeasurementTypeKey.PHASE_ANGLE_HIGH, unit = UnitType.DEGREE, color = 0xFF00695C.toInt(), icon = MeasurementTypeIcon.IC_DEFAULT, isEnabled = false, isInternal = true),
