...
public class BluetoothRenphoScale extends BluetoothCommunication {
    private final String TAG = "BluetoothRenphoScale";
    ...
    protected boolean onNextStep(int stepNr) {
        ...
        switch (stepNr) {
            ...
            case 8:
                ...
                break;
            case 9:
                int height = (int) Converters.toCentimeter(user.getBodyHeight(), user.getMeasureUnit());
            ...
            case 17:
                if (characteristic.equals(CHAR_WEIGHT)) {
                    if (value[0] == 0x2e) {
                        ...
                        LogManager.d(TAG, String.format("Weight = 0x%02x, 0x%02x = %f",value[1], value[2], weight_kg));
