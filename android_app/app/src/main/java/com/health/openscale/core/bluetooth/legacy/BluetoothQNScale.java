...
public class BluetoothQNScale extends BluetoothCommunication {
    private final String TAG = "BluetoothQNScale";
        ...
        switch (stepNr) {
            case 0:
                ...
                try {
                    ...
                    ConverterUtils.toInt32Le(date, 0, timestamp);
            ...
            case 2:
                ...
                if (scaleUserWeightUnit == WeightUnit.LB || scaleUserWeightUnit == WeightUnit.ST){
            ...
            case (byte) 16:
                if (data[5] == (byte) 0) {
                    ...
                    if (!this.hasReceived) {
                        ...
                        LogManager.d(TAG, String.format("Weight byte 1 %d", weightByteOne));
                        LogManager.d(TAG, String.format("Weight byte 2 %d", weightByteTwo));
                        LogManager.d(TAG, String.format("Raw Weight: %f", weightKg));
                        ...
                        if (weightKg > 0.0f) {
                            ...
                            LogManager.d(TAG, String.format("resistance1: %d", resistance1));
                            LogManager.d(TAG, String.format("resistance2: %d", resistance2));
