...
object ScaleCatalog {
    ...
    val fixtures: List<Fixture> = listOf(
        ...
        // Elis Solar: advertises the model id R-A012 or R-A020; same 0x55aa protocol as ES-26BB-B.
        device("R-A012", uuid16(0x1A10)) claimedBy RenphoES26BBHandler::class.java,
        device("R-A020", uuid16(0x1A10)) claimedBy RenphoES26BBHandler::class.java,
